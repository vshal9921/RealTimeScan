 ...
 */
package com.vshal9921.realtimescan.org.eclipse.paho.android.service;
...
interface MqttServiceConstants {
  ...
  String CALLBACK_TO_ACTIVITY = TAG
  ...
  String CALLBACK_CLIENT_HANDLE = TAG + "."
                                               + CLIENT_HANDLE;
  String CALLBACK_ERROR_MESSAGE = TAG
                                               + ".errorMessage";
  String CALLBACK_EXCEPTION_STACK = TAG
                                                 + ".exceptionStack";
  String CALLBACK_INVOCATION_CONTEXT = TAG + "."
                                                    + "invocationContext";
  String CALLBACK_ACTIVITY_TOKEN = TAG + "."
                                                + "activityToken";
  String CALLBACK_DESTINATION_NAME = TAG + '.'
                                                  + DESTINATION_NAME;
  String CALLBACK_MESSAGE_ID = TAG + '.'
                                            + MESSAGE_ID;
  String CALLBACK_RECONNECT = TAG + ".reconnect";
  String CALLBACK_SERVER_URI = TAG + ".serverURI";
  String CALLBACK_MESSAGE_PARCEL = TAG + ".PARCEL";
  String CALLBACK_TRACE_SEVERITY = TAG
                                                + ".traceSeverity";
  String CALLBACK_TRACE_TAG = TAG + ".traceTag";
  String CALLBACK_TRACE_ID = TAG + ".traceId";
  String CALLBACK_ERROR_NUMBER = TAG
                                              + ".ERROR_NUMBER";
  ...
  String WAKELOCK_NETWORK_INTENT = TAG + "";
